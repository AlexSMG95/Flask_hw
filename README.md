...
### 5. Редактирование объявления по ID (PUT /ads/{ad_id})

Редактирует информацию об объявлении по его ID.

#### Запрос
```bash
curl -X PUT http://127.0.0.1:5000/ads/1 \
-H "Content-Type: application/json" \
-H "Authorization: Bearer <your-jwt-token>" \
...
### 6. Удаление объявления (DELETE /ads/{ad_id})
...
#### Запрос
### 7. Тестирование без авторизации (POST /ads)
